...
nmap { "<leader>ff", "<cmd>Telescope current_buffer_fuzzy_find sorting_strategy=ascending prompt_position=top<CR>" }
nmap { "<leader>fh", "<cmd>Telescope find_files sorting_strategy=ascending prompt_position=top<CR>" }
